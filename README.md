...
local Window = OrionLib:MakeWindow({Name = "Tavorxt Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Tavorxt Hub"})
...
W:AddLabel("[+] Tavorxt Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Tavorxt Hub(Noitification)",
